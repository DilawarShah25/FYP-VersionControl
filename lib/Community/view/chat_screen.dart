  ...
  Future<void> _sendMessage() async {
    ...
    try {
      ...
      if (e.toString().contains('Recipient not found')) {
        ...
        errorMsg = 'Unable to send message. Please check your login status or try again.';
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        if (_errorMessage!.contains('Permission denied') || _errorMessage!.contains('Network error'))
                          TextButton(
