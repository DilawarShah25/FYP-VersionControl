...
class _CarouselState extends State<Carousel> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _gradientColor1 = ColorTween(
      begin: const Color(0xFF004D6D), // Deep blue (health, trust)
      end: const Color(0xFF00BFA5), // Teal (technology, vitality)
    ).animate(_animationController);
    _gradientColor2 = ColorTween(
      begin: const Color(0xFFE0F2F1), // Silver/white (cleanliness)
      end: const Color(0xFF4CAF50), // Soft green (growth, renewal)
    ).animate(_animationController);
    _startAutoSlide();
          ...
          return Container(
            decoration: BoxDecoration(
              gradient: LinearGradient(
                colors: [
                  _gradientColor1.value!, // Deep blue to teal
                  _gradientColor2.value!, // Silver to soft green
                  _gradientColor1.value!.withOpacity(0.5), // Blend for depth
                ],
                stops: const [0.0, 0.5, 1.0], // Simultaneous mixing
